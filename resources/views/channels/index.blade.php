<x-app-layout>
    ...
    <div class="channel-tabs">
        ...
        <button class="tab-btn" data-filter="public">{{ org_trans('active') }}</button>
        <button class="tab-btn" data-filter="private">{{ org_trans('inactive') }}</button>
    </div>
            ...
            <div class="channel-header">
                ...
                <div class="channel-info">
                    ...
                    <span class="channel-type type-{{ $channel->type }}">
                        {{ ucfirst($channel->type === 'public' ? org_trans('public') : ($channel->type === 'private' ? org_trans('private') : org_trans('department'))) }}
                    </span>
                </div>
            </div>
