<x-app-layout>
    <style>
        ...
        .column-todo { border-top: 3px solid #60a5fa; }
        .column-in-progress { border-top: 3px solid #fbbb2a; }
        .column-completed { border-top: 3px solid #34d399; }
    ...
    <div class="p-8">
        ...
        <div class="filters-bar">
            ...
            <select class="filter-select" onchange="window.location.href='{{ route('web.tasks') }}?priority=' + this.value">
                ...
                <option value="urgent" {{ request('priority') == 'urgent' ? 'selected' : '' }}>{{ org_trans('priority') }}</option>
                <option value="high" {{ request('priority') == 'high' ? 'selected' : '' }}>{{ org_trans('priority') }}</option>
                <option value="medium" {{ request('priority') == 'medium' ? 'selected' : '' }}>{{ org_trans('priority') }}</option>
                <option value="low" {{ request('priority') == 'low' ? 'selected' : '' }}>{{ org_trans('priority') }}</option>
            </select>
        ...
        <div class="kanban-container">
            ...
            <div class="kanban-column column-todo" data-status="todo">
                <div class="column-header">
                    <div class="column-title">
                        <svg width="20" height="20" fill="currentColor" viewBox="0 0 16 16" style="color: #60a5fa;">
            ...
            <div class="kanban-column column-in-progress" data-status="in_progress">
                <div class="column-header">
                    <div class="column-title">
                        <svg width="20" height="20" fill="currentColor" viewBox="0 0 16 16" style="color: #fbbb2a;">
            ...
            <div class="kanban-column column-done" data-status="done">
                <div class="column-header">
                    <div class="column-title">
                        <svg width="20" height="20" fill="currentColor" viewBox="0 0 16 16" style="color: #10b981;">
