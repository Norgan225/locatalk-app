<x-app-layout>
    ...
    <div class="task-form-page">
        <div class="page-header">
            <h1 class="page-title">{{ org_trans('create_task') }}</h1>
            <p class="page-subtitle">Ajoutez une nouvelle tâche à votre tableau de bord</p>
        </div>
        ...
        <div class="glass-panel">
            <form action="{{ route('web.tasks.store') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="title" class="form-control" required placeholder="Ex: Refonte de la page d'accueil">
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea name="description" class="form-control" placeholder="Détaillez la tâche..."></textarea>
                </div>
                ...
                <!-- Status (Hidden default to todo, or selectable if needed) -->
